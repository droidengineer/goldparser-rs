...
impl ProductionRule {
    // pub fn new(index: usize, nonterminal: Symbol, symbols: Vec<Symbol>) -> Self {
...
// impl From<ProductionRecord> for ProductionRule {
//     fn from(rec: ProductionRecord) -> Self {
        
//         ProductionRule {
//             index: rec.index as usize,
//             head: 
//         }
//     }
// }
